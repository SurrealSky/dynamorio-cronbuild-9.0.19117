...
EXTERN d_r_ss_value:PROC


        d_r_set_ss_selector PROC

        mov      eax, ss
        mov      dword ptr [d_r_ss_value], eax
        ret
        d_r_set_ss_selector ENDP
...
smc_transfer_to_64:
 ...
 push     edi 
        ...
        DB 048h 
 mov      ecx, dword ptr [eax + 8*6] 
        push     ecx 
        DB 048h 
 mov      ecx, dword ptr [eax + 8*5] 
        push     ecx 
        sub      esp, 32         
        
        DB 04ch 
 mov      ecx, dword ptr [eax + 8*4] 
        DB 04ch 
 mov      eax, dword ptr [eax + 8*3] 
        DB 048h 
 mov      edx, dword ptr [eax + 8*2] 
        DB 048h 
 mov      ecx, dword ptr [eax + 8*1] 
        DB 048h 
...
smc_return_to_32:
        ...
        mov      ebx, dword ptr [d_r_ss_value]
        mov      ss, ebx
