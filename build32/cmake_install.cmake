...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/cmake" TYPE FILE FILES
    "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/cmake/DynamoRIOConfig.cmake"
    "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/cmake/DynamoRIOConfigVersion.cmake"
    )
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/cmake" TYPE FILE FILES "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/cmake/cpp2asm_defines.h")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/tools" TYPE FILE FILES "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/tools/list32")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/." TYPE DIRECTORY FILES "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/include" REGEX "annotations/valgrind.h|annotations/memcheck.h" EXCLUDE)
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib32" TYPE DIRECTORY PERMISSIONS OWNER_READ OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE FILES "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/lib32/" FILES_MATCHING REGEX "/[^/]*\\.debug$" REGEX "/[^/]*\\.pdb$" REGEX ".*.dsym/.*dwarf/.*" REGEX "/dynamorio\\.pdb$" EXCLUDE REGEX "/libdynamorio\\.so\\.[^/]*debug$" EXCLUDE REGEX "/libdrpreload\\.so\\.debug$" EXCLUDE REGEX "/policy\\_static\\.pdb$" EXCLUDE REGEX ".*dynamorio.*.dsym/.*" EXCLUDE REGEX "libdrpreload.*.dsym/.*" EXCLUDE REGEX "policy_static.*.dsym/.*" EXCLUDE)
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib32/release" TYPE DIRECTORY PERMISSIONS OWNER_READ OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE FILES "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/lib32/release/" FILES_MATCHING REGEX "/dynamorio\\.pdb$" REGEX "/libdynamorio\\.so\\.[^/]*debug$" REGEX "/libdrpreload\\.so\\.debug$" REGEX ".*dynamorio.*.dsym/.*dwarf/.*" REGEX "libdrpreload.*.dsym/.*dwarf/.*")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin32" TYPE DIRECTORY PERMISSIONS OWNER_READ OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE FILES "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/bin32/" FILES_MATCHING REGEX "/[^/]*\\.debug$" REGEX "/[^/]*\\.pdb$" REGEX ".*.dsym/.*dwarf/.*" REGEX "/runstats\\.debug$" EXCLUDE REGEX "/run\\_in\\_bg\\.debug$" EXCLUDE REGEX "/[^/]*\\_exe\\.debug$" EXCLUDE REGEX "runstats.dsym/.*" EXCLUDE REGEX "run_in_bg.dsym/.*" EXCLUDE REGEX ".*_exe.dsym/.*" EXCLUDE)
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/logs" TYPE FILE FILES "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/logs/README")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(APPEND "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/CMakeFiles/Export/cmake/DynamoRIOTarget32.cmake" "
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/cmake/DynamoRIOTarget32.cmake")
    file(DIFFERENT EXPORT_FILE_CHANGED FILES
         ...
         "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/CMakeFiles/Export/cmake/DynamoRIOTarget32.cmake")
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/cmake" TYPE FILE FILES "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/CMakeFiles/Export/cmake/DynamoRIOTarget32.cmake")
  if("${CMAKE_INSTALL_CONFIG_NAME}" MATCHES "^([Rr][Ee][Ll][Ww][Ii][Tt][Hh][Dd][Ee][Bb][Ii][Nn][Ff][Oo])$")
    file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/cmake" TYPE FILE FILES "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/CMakeFiles/Export/cmake/DynamoRIOTarget32-relwithdebinfo.cmake")
  endif()
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for each subdirectory.
  include("D:/work/program/dynamorio-cronbuild-9.0.19117/build32/core/cmake_install.cmake")
  include("D:/work/program/dynamorio-cronbuild-9.0.19117/build32/libutil/cmake_install.cmake")
  include("D:/work/program/dynamorio-cronbuild-9.0.19117/build32/tools/cmake_install.cmake")
  include("D:/work/program/dynamorio-cronbuild-9.0.19117/build32/tools/DRstats/cmake_install.cmake")
  include("D:/work/program/dynamorio-cronbuild-9.0.19117/build32/clients/cmake_install.cmake")
  include("D:/work/program/dynamorio-cronbuild-9.0.19117/build32/ext/cmake_install.cmake")
  include("D:/work/program/dynamorio-cronbuild-9.0.19117/build32/api/samples/cmake_install.cmake")
...
file(WRITE "D:/work/program/dynamorio-cronbuild-9.0.19117/build32/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
