...
lea rsp, [rsp + (- ((6)*(64)) - ((8)*(8)) - 48)] 
 push qword ptr [rsp + 2*8 - (- ((6)*(64)) - ((8)*(8)) - 48)] 
 pushfq 
 push r15 
 push r14 
 push r13 
 ...
 mov [(3*8) + rsp], rax 
        ...
        mov      rax, qword ptr [rsp + ((3*8))]
        lea      rax, [rax + 3*8]
        mov      qword ptr [rsp + ((3*8))], rax
        
        mov      rax, qword ptr [rsp + (18*8 + 48 + ((6)*(64)) + ((8)*(8))) + 8]
        
        mov      rcx, qword ptr [rax]
        
        mov      qword ptr [rsp + (((3*8)) + 4*8)], rcx
        lea rsp, [-32 - 8*0 + rsp] 
 mov rdx, rdx 
 mov rcx, rax 
